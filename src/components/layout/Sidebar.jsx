      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b border-notion-border">
        ...
        {!collapsed && (
          <motion.span
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="font-bold text-notion-text text-base tracking-tight"
          >
            BugTrackr
          </motion.span>
        )}
        <button
          ...
          className="ml-auto text-notion-muted hover:text-notion-text transition-colors"
        >
          <svg
            className="w-4 h-4"
            fill="none"
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-notion-muted truncate">
                {user?.role}
              </p>
            </div>
          )}
          {!collapsed && (
            <button
              onClick={logout}
              className="text-notion-muted hover:text-red-400 transition-colors"
              title="Logout"
            >
              <svg
                className="w-4 h-4"
