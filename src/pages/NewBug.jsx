        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="card space-y-3">
            ...
            <label className="flex flex-col items-center justify-center border-2 border-dashed border-notion-border rounded-xl p-8 cursor-pointer hover:border-notion-accent/40 transition-colors group">
              ...
              />
              <svg
                className="w-8 h-8 text-notion-muted group-hover:text-notion-accent transition-colors mb-2"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <p className="text-xs text-notion-muted">
                Click to upload screenshots (max 5, 10MB each)
              </p>
            </label>
            {files.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {files.map((f, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-1.5 text-xs bg-notion-hover px-2.5 py-1.5 rounded-lg border border-notion-border"
                  >
                    <svg
                      className="w-3 h-3 text-notion-accent"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <button
                      ...
                      className="text-notion-muted hover:text-red-400"
                    >
                      ×
                    </button>
                  </div>
