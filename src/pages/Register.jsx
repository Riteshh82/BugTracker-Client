    ...
    <div className="min-h-screen bg-notion-bg flex items-center justify-center p-4">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-notion-muted text-sm mt-1">Join your team on BugTrackr</p>
        </div>
        ...
        <div className="card border-notion-border/60 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select id="reg-role" className="input" value={form.role} onChange={e => setForm(p => ({ ...p, role: e.target.value }))}>
          ...
          <p className="text-center text-notion-muted text-sm mt-4">
            ...
            <Link to="/login" className="text-notion-accent hover:underline font-medium">Sign in</Link>
          </p>
        </div>
      </motion.div>
    </div>
