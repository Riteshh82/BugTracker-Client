  ...
  return (
    <div className="min-h-screen bg-notion-bg flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-notion-accent/10 rounded-full blur-3xl" />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-notion-text">BugTrackr</h1>
          <p className="text-notion-muted text-sm mt-1">Sign in to your workspace</p>
        </div>
        ...
        <div className="card border-notion-border/60 shadow-2xl">
          ...
          <p className="text-center text-notion-muted text-sm mt-4">
            ...
            <Link to="/register" className="text-notion-accent hover:underline font-medium">Create one</Link>
          </p>
        </div>
      </motion.div>
    </div>
